...
public class MovieService(IMovieRepository repository, IRatingRepository ratingRepository, IValidator<Movie> movieValidator) : IMovieService
{
    ...
    {
        return repository.GetAllAsync(userId, token);
    }
